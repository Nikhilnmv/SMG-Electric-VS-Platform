      ...
      <div className="bg-white border-b border-gray-200 shadow-sm sticky top-0 z-40">
          ...
          <div className="flex items-center justify-between h-24">
            <div className="flex items-center gap-4">
              ...
              >
                <img src="/smg-logo.png" alt="SMG" className="h-[250px] lg:h-[100px] w-auto absolute left-[-7px] top-[-3px] text-left" />
              </Link>
            </div>
          </div>
        </div>
            ...
            <aside className="fixed left-0 top-0 bottom-0 w-64 bg-[#0B214A] shadow-xl overflow-y-auto">
              <div className="flex items-center justify-between p-4 border-b border-white/10">
                <Link 
                  ...
                  className="flex items-center"
                >
                  <img src="/smg-logo.png" alt="SMG" className="h-20 w-auto" />
                </Link>
                <button
